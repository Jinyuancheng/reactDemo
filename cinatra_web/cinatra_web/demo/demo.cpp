...
void Server1()
{
	...
	bool ret = server1.listen("0.0.0.0", "10087");
	if (!ret)
	{
...
void jinzi()
{
	std::cout << "Server1 Liten Port : " << "10087" << std::endl;
...
int main1() {
	...
	thread_group.create_thread(Server1);*/
	boost::thread thread1(Server1);
...
#else
	bool r = server.listen("0.0.0.0", "10086");
	...
	std::cout << "Server Liten Port : " << "10086" << std::endl;
